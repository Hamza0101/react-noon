...
export default function EditModal(props) {
  ...
  const [phoneNo, setPhoneNo] = useState(props.data.phoneNo);
  const [fullAddress, setFullAddress] = useState(props.data.fullAddress);
  const [label, setLabel] = useState(props.data.label);
  const [defaultAddress, setDefaultAddress] = useState(
    props.data.defaultAddress
  );
              ...
              <div class="pl-4">
                <div className="d-flex">
                  ...
                  <img
                    ...
                    className=""
                  />
                  <p className="mx-2"> H6 Dubai happy villas,</p>
                  <p>
